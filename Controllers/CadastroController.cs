...
namespace ProjetoGame.Controllers
{
    public class CadastroController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CadastroId,CadastroNome,CadastroName")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CadastroId,CadastroNome,CadastroName")] Cadastro cadastro)
        {
